...
(function() {
    ...
    var vertexPos = [
        ...
        -0.5, 1.0, -0.5,
         0.0, 2.0,  0.0,
         -1.5,-1.5,-1.5,  1.5,-1.5,-1.5,  1.5, 1.5,-1.5,        -1.5,-1.5,-1.5,  1.5, 1.5,-1.5, -1.5, 1.5,-1.5,    // z = 0
                    -.5,-1.5, .5,  .5,-1.5, .5,  .5, 1.5, .5,        -.5,-1.5, .5,  .5, 1.5, .5, -.5, 1.5, .5,    // z = 1
                    -.5,-1.5,-.5,  .5,-1.5,-.5,  .5,-1.5, .5,        -.5,-1.5,-.5,  .5,-1.5, .5, -.5,-1.5, .5,    // y = 0
                    -.5, 1.5,-.5,  .5, 1.5,-.5,  .5, 1.5, .5,        -.5, 1.5,-.5,  .5, 1.5, .5, -.5, 1.5, .5,    // y = 1
                    -.5,-1.5,-.5, -.5, 1.5,-.5, -.5, 1.5, .5,        -.5,-1.5,-.5, -.5, 1.5, .5, -.5,-1.5, .5,    // x = 0
                     .5,-1.5,-.5,  .5, 1.5,-.5,  .5, 1.5, .5,         .5,-1.5,-.5,  .5, 1.5, .5,  .5,-1.5, .5 
    ];
